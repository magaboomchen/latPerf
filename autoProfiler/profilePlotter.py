...
class ProfilePlotter(object):
    def __init__(self):
        ...
        self.dataSet = []
        self.dataNum = 0
        self.whis_value = (0,99.0) #1.5

    def addLatencyDict(self, latencysDict, xticklabels):
        data = []
        ...
        self.xticklabels = xticklabels #range(1,len(latencysDict)+1)
    ...
    def _tuneStyle(self):
        self.ax.legend(self.boxDictList, self.legendNameSet, fontsize=fs.LEGEND_SIZE, loc='best').get_frame().set_linewidth(fs.LEGEND_EDGE_WIDTH)
